package com.sdu.apiboss.service.sys_user.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.sdu.apiboss.mapper.SysUserMapper;
import com.sdu.apiboss.service.email.EmailService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    @Override
    public IPage<SysUser> list(SysUserPagePara para) {
        // 构造分页对象
    ...
    public Result checkUserAndEmail(SysUser sysUser) {
        ...
        if (isExistUser(username)) {
            ...
            if (email.equals(storeEmail)) {
                ...
                // 发送html邮件到对应的邮箱号
                String title = "重置密码-来自网约车后台管理系统";
                String content = "<html>\n" +
                        "<body>\n" +
                        "<h3>" + "用户" + username + "：你好！"+"</h3>\n" +
                        "<p>" + "你正在网约车后台管理系统进行重置密码操作，" +
                        "您本次重置密码的验证码为：<br/>" +
                        "<p style=\"font-size:24px; color: #409EFF\">" + code + "</p>" +
                        "请在5分钟之内填写验证码！"+
                        "<br/>如果非本人操作，请忽略本邮件，如有疑问，欢迎致信 752869332@qq.com 。" +
                        "</p>" +
                        "</body>\n" +
                        "</html>\n";
                // 发送Html邮件时间相对较长
